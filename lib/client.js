...
export class RealtimeClient extends RealtimeEventHandler {
  ...
  async connect() {
    ...
    console.log("KDLF: Sending initial session config on connect:", JSON.stringify(session, null, 2));
  ...
  updateSession({
    ...
    const session = { ...this.sessionConfig };
    session.tools = useTools;
    console.log("KDLF: Sending session update:", JSON.stringify(session, null, 2));
